...
const GALLERY_ITEMS = [
  ...
  { label: 'Kitchen Remodel', cols: 2, rows: 1, src: '/images/kitchen-1.jpg', contain: false },
  { label: 'Modern Kitchen', cols: 1, rows: 1, src: '/images/kitchen-2.jpg', contain: false },
  { label: 'Kitchen Renovation', cols: 3, rows: 1, src: '/images/kitchen-3.jpg', contain: false },
]
